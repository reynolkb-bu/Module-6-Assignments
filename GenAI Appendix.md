...
I will start by saying that I have been in software for over 11 years. The first half of my career I was in client-facing roles. The second half, I've been in engineering, and I'm currently a software engineering manager. Over the past 3 years, AI has completely changed how engineers code and interact with code. Most engineers now are using AI to completely write the code. You don't write the code by hand anymore. Engineers are reading the outputs from AI and ensuring the code lines up with best practice. However they are required to do a lot more now so someone who only does server engineering is also required to do some firmware and frontend engineering as an example.
